...
//fym 处理非RTSP请求数据回调函数类型
typedef void (CALLBACK* DataCallBackFunc)(const char* data, const unsigned long& length);
...
class QTSServer : public QTSServerInterface
{
	...
	public://fym
		static DataCallBackFunc fDataCallBackFunc;//fym 处理收到的非RTSP请求数据
};
