...
enum
{
	...
	//fym
	 QTSS_AddRelaySource_Role =  FOUR_CHARS_TO_INT('a', 'r', 's', 'c'),  //arsc 增加转发源
	 QTSS_RemoveRelaySource_Role =  FOUR_CHARS_TO_INT('r', 'r', 's', 'c'),  //rrsc 删除转发源
	 QTSS_InputStreamData_Role =  FOUR_CHARS_TO_INT('i', 'p', 's', 'd'),  //ipsd //输入媒体数据待转发
	 //QTSS_RemoveReflectorSession_Role =  FOUR_CHARS_TO_INT('r', 'm', 'r', 's'),  //ipsd //删除转发Session
