...
#include "FakeRTSPClient.h"//fym #include "RTSPClient.h"
#include "XMLParser.h"
...
class RTSPSourceInfo : public RCFSourceInfo
{
    public:
        ...
        FakeRTSPClient* GetRTSPClient()     { return fClient; }
		...
		//指定转发url
		void AddRelayDestinations(char* src_ip, UInt16 src_port, char* src_url, char* dest_url);//fym
	...
	private:
        ...
        {
            public:
                TeardownTask(TCPClientSocket* clientSocket, FakeRTSPClient* client);
