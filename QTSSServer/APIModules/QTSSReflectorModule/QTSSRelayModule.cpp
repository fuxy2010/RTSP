...
//OSQueue* sRTSPSourceInfoQueue = NULL;//fym 为输入数据时查询用
...
//fym 以uuid代替src_port,暂定每个转发源有两个stream
QTSS_Error AddRelaySource(QTSS_RelayStreamData_Params* inParams)
{
	...
	theRTSPInfo->StartSessionCreatorTask(sSessionQueue, sRTSPSourceInfoQueue);//fym 将自身插入sRTSPSourceInfoQueue
