...
class ClientSocket
{
    public:
		...
		virtual OS_Error send_media_data(const char* data, const unsigned short length, const unsigned char type) = 0;//fym
...
class TCPClientSocket : public ClientSocket
{
    public:
		...
		virtual OS_Error send_media_data(const char* data, const unsigned short length, const unsigned char type);//fym
