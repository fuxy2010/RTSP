...
QTSS_Error  QTSSModule::AddRole(QTSS_Role inRole)
{
    ...
    switch (inRole)
    {
		...
		case QTSS_AddRelaySource_Role:			fRoleArray[kAddRelaySource] = true;			break;//fym
		case QTSS_RemoveRelaySource_Role:		fRoleArray[kRemoveRelaySource] = true;      break;//fym
		case QTSS_InputStreamData_Role:			fRoleArray[kInputStreamData] = true;		break;//fym
		//case QTSS_RemoveReflectorSession_Role:	fRoleArray[kRemoveReflectorSession] = true;	break;//fym
        default:
