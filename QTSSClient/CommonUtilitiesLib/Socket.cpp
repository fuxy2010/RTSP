...
{
    //fym Assert(fFileDesc == EventContext::kInvalidFileDesc);
...
{
    //fym Assert(outRecvLenP != NULL);
    //fym Assert(buffer != NULL);
	if(NULL == outRecvLenP || NULL == buffer)//fym
		return ENOMEM;
